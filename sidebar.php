    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          ...
          <li class="nav-item">
            <a href="./index.php?page=product_list" class="nav-link nav-product_list">
              <i class="nav-icon fas fa-columns"></i>
              <p>
                Brand & Product
              </p>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_supplier">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Supplier
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_supplier" class="nav-link nav-new_supplier tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=supplier_list" class="nav-link nav-supplier_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
