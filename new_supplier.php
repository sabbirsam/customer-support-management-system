			...
			<form action="" id="manage_staff">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<b class="text-muted">Supplier Information</b>
						...
						<div class="form-group">
							<label class="control-label">Brand/Address</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="product_id" id="product_id" class="custom-select custom-select-sm select2">
								<option value=""></option>
							<?php
								$department = $conn->query("SELECT * FROM product order by product_name asc");
								while($row = $department->fetch_assoc()):
							?>
								<option value="<?php echo $row['id'] ?>" <?php echo isset($product_id) && $product_id == $row['id'] ? "selected" : '' ?>><?php echo ucwords($row['product_name']) ?></option>
							<?php endwhile; ?>
							</select>
						</div>
