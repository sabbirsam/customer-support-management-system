...
<?php 
$qry = $conn->query("SELECT t.*,email as email, concat(lastname,', ',firstname,' ',middlename) as cname, d.name as dname FROM supplier t inner join departments c on c.id= t.department_id inner join departments d on d.id = t.department_id where t.id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
	// print_r($k);
}
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<p class="ml-2 d-list"><b><?php echo ucwords("WDSUPN00". $id) ?></b></p>
