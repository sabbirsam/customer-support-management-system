...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 08, 2022 at 05:03 PM
...
INSERT INTO `supplier` (`id`, `product_id`, `firstname`, `lastname`, `middlename`, `contact`, `address`, `email`, `password`, `date_created`) VALUES
(1, 1, 'supplier George', 'Wilson', 'K', '+6948 8542 623', 'Sample Address', 'supplier@sample.com', '81dc9bdb52d04dc20036dbd8313ed055', '2020-11-09 11:59:01'),
(2, 6, 'Kodu', 'jodu', 'hasan', '4554', 'Walton', 'kodu@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '2022-04-08 14:41:41'),
(3, 4, 'Stuff', 'One', 'Test', '0130449896848', 's', 'sa@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', '2022-04-08 15:38:36');
...
CREATE TABLE IF NOT EXISTS `supplier_ticket` (
  `id` int(30) NOT NULL AUTO_INCREMENT,
  `select_suplier_id` int(30) NOT NULL,
  `Ticket_id` int(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
...
(3, 'IUBAT Didir Canteen Walton Fridge issues  ', '&lt;p&gt;Walton fridge creating problem&amp;nbsp;&lt;/p&gt;', 0, 3, 4, 5, 0, '2022-03-26 23:47:31');
