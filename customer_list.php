...
<div class="col-lg-12">
	...
	<div class="pdf_container" style="padding-bottom:4px">
          <form class="form-inline" method="post" action="customer_list_pdf.php">
			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td><b><?php echo ucwords("CN0000". $row['id']) ?></b></td>
						...
						<td class="text-center">
							...
							<a class="dropdown-item view_ticket" href="./index.php?page=view_customer&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">Details</a>
